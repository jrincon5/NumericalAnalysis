 ...
 */
public class SolutionGaussSeidel extends Fragment implements View.OnClickListener{
    View rootView;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        rootView = inflater.inflate(R.layout.tab_solution_gauss_seidel, container, false);
        txt_MatrixA=(TextView) rootView.findViewById(R.id.text_matrixA_Gauss_Seidel);
        txt_VectorB=(TextView) rootView.findViewById(R.id.text_vectorB_Gauss_Seidel);
        txt_MatrixT=(TextView) rootView.findViewById(R.id.text_matrixT_Gauss_Seidel);
        txt_VectorC=(TextView) rootView.findViewById(R.id.text_vectorC_Gauss_Seidel);
        txt_VectorX=(TextView) rootView.findViewById(R.id.text_vectorX_Gauss_Seidel);

        btn_showSolution=(Button) rootView.findViewById(R.id.button_show_solution_gauss_seidel);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.button_show_solution_gauss_seidel:
                mA=buildMa();
                vB=buildVb();
                buildVinit();
                GaussSeidel(Iterations, Tolerance, Delta);
    ...
    public void GaussSeidel(int iter, double toler, double delta){
        ...
        Matrix inver = new Matrix(1, filas);
        ...
        inver = D.minus(L);
        T = inver.inverse().times(U);
        C = inver.inverse().times(vectorB);
