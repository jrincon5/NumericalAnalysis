 ...
 */
public class SolutionRichardson extends Fragment implements View.OnClickListener{
    View rootView;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        rootView = inflater.inflate(R.layout.tab_solution_richardson, container, false);
        txt_MatrixA=(TextView) rootView.findViewById(R.id.text_matrixA_Richardson);
        txt_VectorB=(TextView) rootView.findViewById(R.id.text_vectorB_Richardson);
        txt_MatrixT=(TextView) rootView.findViewById(R.id.text_matrixT_Richardson);
        txt_VectorC=(TextView) rootView.findViewById(R.id.text_vectorC_Richardson);
        txt_VectorX=(TextView) rootView.findViewById(R.id.text_vectorX_Richardson);

        btn_showSolution=(Button) rootView.findViewById(R.id.button_show_solution_richardson);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.button_show_solution_richardson:
                mA=buildMa();
                vB=buildVb();
                buildVinit();
                Richardson(Iterations, Tolerance, Delta);
    ...
    public void Richardson(int iter, double toler, double delta){
        ...
        Matrix I = new Matrix(filas, filas);
